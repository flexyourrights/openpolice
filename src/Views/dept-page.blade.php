...
@if (isset($deptStuff["deptRow"]))
    ...
    <div class="row w100">
        <div class="col-md-4">
            ...
            <a class="btn btn-primary btn-lg w100 mT20" 
            ...
            <a name="how"></a>
            <h3 class="mT20 mB0">How To File A Complaint</h3>
            ...
            @if (isset($deptStuff[$deptStuff["whichOver"]]->OverOfficialFormNotReq) 
                ...
                <h4><i class="fa fa-trophy mR5" aria-hidden="true"></i> OPC-Compatible Department</h4>
                <p class="mB20">
            ...
            @endif
                    ...
                    @if (isset($deptStuff[$deptStuff["whichOver"]]->OverWaySubOnline) 
                        ...
                        (TIP: Drop in a link to your OPC complaint too!)<br /><a href="{{ 
        ...
        <div class="col-md-4">
            ...
            @if (isset($deptStuff["deptRow"]->DeptScoreOpenness) && intVal($deptStuff["deptRow"]->DeptScoreOpenness) > 0)
                ...
                <div id="toggleScoreInfoDeets" class="disBlo">
...
<div class="mT20 brd round10 p20 fPerc133">
    See something inaccurate? Please <a href="/contact">contact us</a> or 
    <a href="/dashboard/volunteer">volunteer</a> to update these records.
</div>
