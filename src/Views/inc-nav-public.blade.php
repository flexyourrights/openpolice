...
@else
	...
	<li><a href="/auth/login" title="Please login to continue your unfinished complaint, or to post an update on your case.">Login</a></li>
	<li><a href="/auth/register" title="Please sign up to help make Open Police Complaints better!">Volunteer</a></li>
	<!--- <li><a href="https://OpenPoliceComplaints.org/articles/" target="_blank"><i class="fa fa-question-circle"></i></a></li> --->
