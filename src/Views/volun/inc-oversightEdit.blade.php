    ...
    <div class="col-md-6">
        ...
        @else 
            ...
            <fieldset class="form-group">
                ...
                <input id="CivOverAgncNameID" name="CivOverAgncName" 
                    value="{{ $overRow->OverAgncName }}" type="text" class="form-control input-lg" > 
            </fieldset>
            <fieldset class="form-group">
                ...
                <input id="{{ $overType }}OverWebsiteID" name="{{ $overType }}OverWebsite" 
                    value="{{ $overRow->OverWebsite }}" type="text" class="form-control input-lg" >
            </fieldset>
            <fieldset class="form-group">
                <label for="CivOverCivModel">Civilian Oversight Model</label>
                <select id="CivOverCivModelID" name="CivOverCivModel" class="form-control input-lg">
        ...
        <fieldset class="form-group">
            ...
            <input id="{{ $overType }}OverEmailID" name="{{ $overType }}OverEmail" 
                value="{{ $overRow->OverEmail }}" type="text" class="form-control input-lg" >
        </fieldset>
        <fieldset class="form-group">
            ...
            <div class="col-md-6">
                <fieldset class="form-group">
                    ...
                    <input id="{{ $overType }}OverAddressCityID" name="{{ $overType }}OverAddressCity" 
                        value="{{ $overRow->OverAddressCity }}" type="text" class="form-control input-lg" > 
                </fieldset>
            </div>
            <div class="col-md-3">
                <fieldset class="form-group">
                    <label for="{{ $overType }}OverAddressStateID">State</label>
                    <select id="{{ $overType }}OverAddressStateID" name="{{ $overType }}OverAddressState" class="form-control input-lg" autocomplete="off" >
                        {!! $stateDrop !!}
                    </select>
                </fieldset>
            </div>
            <div class="col-md-3">
                <fieldset class="form-group">
                    ...
                    <input id="{{ $overType }}OverAddressZipID" name="{{ $overType }}OverAddressZip" 
                        value="{{ $overRow->OverAddressZip }}" type="text" class="form-control input-lg" > 
                </fieldset>
            </div>
        </div>
        @if ($overType == 'Civ')
