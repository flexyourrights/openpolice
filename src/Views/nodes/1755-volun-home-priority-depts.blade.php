...
<h2 class="mT0"><i class="fa fa-warning slRedDark" aria-hidden"true"=""></i> High-Priority Departments</h2>
@if (sizeof($deptPriorityRows) > 0)
    {!! view('vendor.openpolice.volun.dept-rows', [ "deptRows" => $deptPriorityRows ])->render() !!}
@else
